...
const ResumeBuilderApp = () => {
  ...
  const updateHighlight = useCallback((expId: string, index: number, value: string) => {
    setResume(prev => ({
      ...prev,
      experience: prev.experience.map(exp =>
        exp.id === expId
  ...
  const updateSkill = useCallback((catId: string, index: number, value: string) => {
    setResume(prev => ({
      ...prev,
      skills: prev.skills.map(cat =>
        cat.id === catId
          ? { ...cat, skills: cat.skills.map((s, i) => i === index ? value : s) }
          : cat
      ),
    }));
  }, []);
  ...
  // Section icons
  const sectionIcons: Record<ActiveSection, React.ReactNode> = {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h2 className="text-xl font-semibold text-dark-100">Resume Builder</h2>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
            ...
            <div className="card">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-dark-200 font-medium">Contact Information</span>
                </div>
                {activeSection === 'contact' ? <ChevronUp className="w-4 h-4 text-dark-500" /> : <ChevronDown className="w-4 h-4 text-dark-500" />}
              </button>
              ...
              {activeSection === 'contact' && (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      <label className="text-sm text-dark-400 mb-1 block">Phone</label>
                      <input
                        type="tel"
                  ...
                  <div>
                    <label className="text-sm text-dark-400 mb-1 block">Location</label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-sm text-dark-400 mb-1 block">Website</label>
                      <input
                        type="url"
                    ...
                    <div>
                      <label className="text-sm text-dark-400 mb-1 block">LinkedIn</label>
                      <input
                        type="url"
                  ...
                  <div>
                    <label className="text-sm text-dark-400 mb-1 block">GitHub</label>
                    <input
                      type="url"
                  ...
                  <div>
                    <label className="text-sm text-dark-400 mb-1 block">Professional Summary</label>
                    <textarea
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-dark-200 font-medium">Work Experience</span>
                </div>
                <button onClick={addExperience} className="btn-secondary text-sm flex items-center gap-1">
              ...
              <div className="space-y-4">
                {resume.experience.map((exp, idx) => (
                  <div key={exp.id} className="p-4 rounded-lg bg-dark-700/50 border border-dark-600">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-dark-400">Position #{resume.experience.length - idx}</span>
                    ...
                    <div className="space-y-3">
                      ...
                      />
                      <div>
                        <label className="text-sm text-dark-400 mb-2 block">Highlights</label>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={addEducation} className="btn-secondary text-sm flex items-center gap-1">
                  <Plus className="w-3.5 h-3.5" />
                  Add
                </button>
              </div>
              ...
              <div className="space-y-4">
                {resume.education.map((edu, idx) => (
                  <div key={edu.id} className="p-4 rounded-lg bg-dark-700/50 border border-dark-600">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-dark-400">Education #{resume.education.length - idx}</span>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-dark-200 font-medium">Certifications</span>
                </div>
                <button onClick={addCertification} className="btn-secondary text-sm flex items-center gap-1">
                  <Plus className="w-3.5 h-3.5" />
                  Add
                </button>
              </div>
              ...
              <div className="space-y-4">
                {resume.certifications.map((cert, idx) => (
                  <div key={cert.id} className="p-4 rounded-lg bg-dark-700/50 border border-dark-600">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-dark-400">Certification #{resume.certifications.length - idx}</span>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={addAward} className="btn-secondary text-sm flex items-center gap-1">
                  <Plus className="w-3.5 h-3.5" />
                  Add
                </button>
              </div>
              ...
              <div className="space-y-4">
                {resume.awards.map((award, idx) => (
                  <div key={award.id} className="p-4 rounded-lg bg-dark-700/50 border border-dark-600">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-dark-400">Award #{resume.awards.length - idx}</span>
                      <button onClick={() => removeAward(award.id)} className="text-red-400 hover:text-red-300">
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
                    <div className="space-y-3">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={addSkillCategory} className="btn-secondary text-sm flex items-center gap-1">
                  <Plus className="w-3.5 h-3.5" />
                  Add Category
                </button>
              </div>
              ...
              <div className="space-y-4">
                {resume.skills.map((cat, idx) => (
                  <div key={cat.id} className="p-4 rounded-lg bg-dark-700/50 border border-dark-600">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-sm text-dark-400">Category #{resume.skills.length - idx}</span>
                      <button onClick={() => removeSkillCategory(cat.id)} className="text-red-400 hover:text-red-300">
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
                    <div className="space-y-3">
                      ...
                      />
                      <div>
                        <label className="text-sm text-dark-400 mb-2 block">Skills</label>
        ...
        <div className="card p-0 overflow-hidden sticky top-6">
          <div className="p-4 border-b border-dark-600 flex items-center justify-between">
            <span className="text-dark-400 text-sm">Preview - {AVAILABLE_TEMPLATES.find(t => t.id === selectedTemplate)?.name} Template</span>
        ...
        <div style={{ flex: '2.2' }}>
          ...
          <div style={{ marginBottom: '20px', textAlign: 'center' as const, paddingBottom: '16px', borderBottom: `2px solid ${accentHex}` }}>
            ...
            {(contact.linkedin || contact.github || contact.website) && (
              <p style={{ fontSize: '10px', color: '#888', margin: '4px 0 0 0', lineHeight: '1.6' }}>
          ...
          {contact.summary && (
            <>
              ...
              <p style={{ ...styles.text, textAlign: 'justify' as const }}>{contact.summary}</p>
            </>
          )}
                  ...
                  {exp.highlights.filter(Boolean).length > 0 && (
                    <ul style={{ margin: '6px 0', paddingLeft: '18px' }}>
                      {exp.highlights.filter(Boolean).map((h, i) => (
                        <li key={i} style={{ ...styles.text, marginBottom: '2px' }}>{h}</li>
                      ))}
                    </ul>
                  )}
                </div>
              ...
              {education.map((edu) => (
                <div key={edu.id} style={{ marginBottom: '10px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                    <span style={styles.subheading}>{edu.degree}{edu.field && ` in ${edu.field}`}</span>
                    <span style={styles.date}>{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</span>
                  </div>
            ...
            <>
              ...
              {certifications.map((cert) => (
                <div key={cert.id} style={{ marginBottom: '10px' }}>
                  ...
                  <p style={{ ...styles.text, fontSize: '10px' }}>{cert.issuer}{cert.date && `, ${cert.date}`}</p>
                </div>
              ))}
            </>
          )}
            ...
            <>
              ...
              {awards.map((award) => (
                <div key={award.id} style={{ marginBottom: '10px' }}>
                  ...
                  <p style={{ ...styles.text, fontSize: '10px' }}>{award.issuer}{award.date && `, ${award.date}`}</p>
                </div>
              ))}
            </>
          )}
        ...
        <>
          ...
          {awards.map((award) => (
            <div key={award.id} style={{ marginBottom: '8px' }}>
              ...
              {award.description && <p style={styles.text}>{award.description}</p>}
            </div>
          ))}
        </>
      )}
